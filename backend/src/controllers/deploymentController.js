...
const allowedFields = ['server_id', 'project_name', 'repo_url', 'branch', 'deploy_path', 'cicd_tool', 'last_commit_id', 'last_commit_message', 'last_author', 'last_deploy_status', 'last_deploy_time', 'build_url'];
