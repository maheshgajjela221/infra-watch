...
const table = 'servers';
const allowedFields = ['name', 'public_ip', 'private_ip', 'provider', 'region', 'environment', 'os_name', 'ssh_user', 'project_path', 'cpu_info', 'ram_total_gb', 'disk_total_gb', 'disk_used_gb', 'disk_free_gb', 'disk_used_percent', 'status', 'notes'];
